...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<body>
			<h3>This is a data archive, to access this file you need the password provided by the administrator (GABRIEL_GGR)</h3>
			<p>
			<h3>Este é um arquivo de dados, para acessar este arquivo você precisa da senha fornecida pelo administrador (GABRIEL_GGR)</h3>
			<div id="container">
				<p>
			...
			<h3>Você pode doar em Bitcoin! (bc1qjypr7z5x0rwtavnc54vkkn02pzyem3eeavz5ks)</h3>
